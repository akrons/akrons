import { IFormElementDefinition, FormElementDefinitionFactory, IFormElementDefinitionInstance } from './form-element-definition';
...
export class FormDefinition {
    public elements: IFormElementDefinitionInstance[];
    ...
    element(id: string): IFormElementDefinitionInstance {
